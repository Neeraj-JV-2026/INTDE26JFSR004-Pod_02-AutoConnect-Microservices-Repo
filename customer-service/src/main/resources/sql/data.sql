...
(3, 'WALK_IN',  'Honda Amaze',      'INTERESTED', 1,    'Prefers white color variant', NOW()),
(4, 'SOCIAL',   'VW Tiguan',        'CONVERTED',  2,    'Converted - quote raised', NOW());

-- Interactions
INSERT INTO interactions (customer_id, user_id, channel, message, timestamp, outcome)
VALUES
(1, 1, 'CALL',      'Discussed CR-V features and pricing. Customer interested in test drive.', NOW(), 'TEST_DRIVE_SCHEDULED'),
(2, 1, 'EMAIL',     'Sent brochure for Toyota Innova Crysta 2024 model.', NOW(), 'FOLLOW_UP'),
(3, 1, 'SMS',       'Confirmed appointment for showroom visit on Saturday.', NOW(), 'APPOINTMENT_CONFIRMED'),
(4, 2, 'IN_PERSON', 'Customer visited showroom, selected Tiguan Comfortline. Initiating paperwork.', NOW(), 'DEAL_CLOSED');
